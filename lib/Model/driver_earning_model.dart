...
//
//     final driverEarningModel = driverEarningModelFromJson(jsonString);

import 'dart:convert';

DriverEarningModel driverEarningModelFromJson(String str) => DriverEarningModel.fromJson(json.decode(str));

String driverEarningModelToJson(DriverEarningModel data) => json.encode(data.toJson());
...
class DriverEarningModel {
  ...
  factory DriverEarningModel.fromJson(Map<String, dynamic> json) => DriverEarningModel(
