...
//
//     final driverCommissionFilterModel = driverCommissionFilterModelFromJson(jsonString);

import 'dart:convert';

DriverCommissionFilterModel driverCommissionFilterModelFromJson(String str) => DriverCommissionFilterModel.fromJson(json.decode(str));

String driverCommissionFilterModelToJson(DriverCommissionFilterModel data) => json.encode(data.toJson());

class DriverCommissionFilterModel {
  bool? success;
  int? count;
  List<Booking>? bookings;

  DriverCommissionFilterModel({
    this.success,
    this.count,
    this.bookings,
  });

  factory DriverCommissionFilterModel.fromJson(Map<String, dynamic> json) => DriverCommissionFilterModel(
...
class Booking {
  ...
  factory Booking.fromJson(Map<String, dynamic> json) => Booking(
    ...
    childSeat: json["child_seat"] == null ? [] : List<ChildSeat>.from(json["child_seat"]!.map((x) => ChildSeat.fromJson(x))),
    name: json["name"],
    email: json["email"],
    mobile: json["mobile"],
    ...
    driver: json["driver"] == null ? null : filterDriver.fromJson(json["driver"]),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "child_seat": childSeat == null ? [] : List<dynamic>.from(childSeat!.map((x) => x.toJson())),
    "name": name,
    "email": email,
    "mobile": mobile,
    "telephone": telephone,
...
class filterDriver {
  ...
  factory filterDriver.fromJson(Map<String, dynamic> json) => filterDriver(
    id: json["id"],
