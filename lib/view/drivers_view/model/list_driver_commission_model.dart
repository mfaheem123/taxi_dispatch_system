...
//
//     final listDriverCommissionModel = listDriverCommissionModelFromJson(jsonString);

import 'dart:convert';

ListDriverCommissionModel listDriverCommissionModelFromJson(String str) => ListDriverCommissionModel.fromJson(json.decode(str));

String listDriverCommissionModelToJson(ListDriverCommissionModel data) => json.encode(data.toJson());

class ListDriverCommissionModel {
  bool? status;
  String? message;
  int? total;
  List<CreateDriverCommission>? drivers;

  ListDriverCommissionModel({
    this.status,
    this.message,
    this.total,
    this.drivers,
  ...
  factory ListDriverCommissionModel.fromJson(Map<String, dynamic> json) => ListDriverCommissionModel(
    status: json["status"],
    message: json["message"],
    total: json["total"],
    drivers: json["drivers"] == null ? [] : List<CreateDriverCommission>.from(json["drivers"]!.map((x) => CreateDriverCommission.fromJson(x))),
  );
...
class CreateDriverCommission {
  ...
  factory CreateDriverCommission.fromJson(Map<String, dynamic> json) => CreateDriverCommission(
    id: json["id"],
