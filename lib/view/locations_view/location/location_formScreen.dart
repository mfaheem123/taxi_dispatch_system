...
import 'package:dashboard_new1/view/locations_view/Model/location_types_zoneModel.dart' hide Center; // Error fix
...
class LocationForm extends StatelessWidget {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      isMobile
                          ? Column(
                        children: [
                          _buildField("LOCATION NAME", controller.locationNameCtrl, inputType: "both"),
                          const SizedBox(height: 10),
                          _buildField("LONGITUDE", controller.longitudeCtrl, inputType: "number"),
                        ],
                      )
                          : Row(
                        children: [
                          Expanded(child: _buildField("LOCATION NAME", controller.locationNameCtrl, inputType: "both")),
                          const SizedBox(width: 10),
                          Expanded(child: _buildField("LONGITUDE", controller.longitudeCtrl, inputType: "number")),
                        ],
                      ),
                      ...
                      isMobile
                          ? Column(
                        children: [
                          _buildField("POSTCODE", controller.postcodeCtrl, inputType: 'both' ),
                          const SizedBox(height: 10),
                          DropdownButtonFormField<ZoneObject>(
                            decoration: const InputDecoration(border: OutlineInputBorder(), isDense: true),
                            value: controller.zoneValue,
                            items: controller.locationtypezoneModel!.zonesList!.map((zone) =>
                                DropdownMenuItem<ZoneObject>(value: zone, child: Text(zone.name ?? ""))).toList(),
                            onChanged: (v) {
                        ...
                        children: [
                          Expanded(child: _buildField("POSTCODE", controller.postcodeCtrl, inputType: "both")),
                          const SizedBox(width: 10),
                          Expanded(
                      ...
                      isMobile
                          ? Column(
                        children: [
                          _buildField("SHORTCUT", controller.shortcutCtrl, inputType: "text"),
                          const SizedBox(height: 10),
                          _buildField("EXTRA CHARGES", controller.extraChargesCtrl, inputType: "number"),
                        ],
                      )
                          : Row(
                        children: [
                          Expanded(child: _buildField("SHORTCUT", controller.shortcutCtrl, inputType: "text")),
                          const SizedBox(width: 10),
                          Expanded(child: _buildField("EXTRA CHARGES", controller.extraChargesCtrl, inputType: "number")),
                        ],
                      ),
                      ...
                      isMobile
                        ...
                        children: [
                          ...
                          const SizedBox(height: 10),
                          _buildField("LATITUDE", controller.latitudeCtrl, inputType: "number"),
                        ],
                      )
                          : Row(
                        crossAxisAlignment: CrossAxisAlignment.end,
                        children: [
                          Expanded(
                            child: CustomDropdownField<LocationTypeObject>(
                              text: "LOCATION TYPE",
                              label: "Location Type",
                              width: double.infinity,
                              height: 40,
                          ...
                          const SizedBox(width: 10),
                          Expanded(child: _buildField("LATITUDE", controller.latitudeCtrl, inputType: "number")),
                        ],
                      ),
                      ...
                      ElevatedButton(
                        ...
                        child: Text(
                          controller.updateLocationValue.value == true ? "UPDATE" : "SAVE",
  ...
  static Widget _buildField(String label, TextEditingController controller, {String inputType = "text"}) {
    Pattern pattern;
    switch (inputType) {
      case "number":
