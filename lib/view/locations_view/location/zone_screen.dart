...
//   FocusNode _clearButtonFocusNode = FocusNode();
...
//                                 .map((e) => DropdownMenuItem(value: e.toUpperCase(), child: Text(e.toUpperCase())))
//                                 .toList(),
...
//                                   shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(5)),
//                                 ),
//                                 child: Text(controller.updateZone.value ? "EDIT" : "SAVE"),
//                               )
//                             ],
//                           ),
//                         ],
...
class _ZoneScreenState extends State<ZoneScreen> {
  ...
  /// Prevents arrow-up/down keys from bubbling to the parent Scrollable
  /// while still allowing the dropdown's own internal menu navigation.
  Widget _noScrollArrowKeys({required Widget child}) {
    return Shortcuts(
      shortcuts: {
