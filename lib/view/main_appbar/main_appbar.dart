...
//
//   // Drawer control for the mobile layout.
//   final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
//
//   // Below this width we render the mobile app bar + drawer instead of the
//   // web NestedMenuBar. Tweak to taste.
//   static const double kMobileBreakpoint = 700;
//
...
//               isMobile ? kToolbarHeight : kToolbarHeight * 2.3),
...
//           );
//         }),
//         bottomNavigationBar: GetBuilder<AuthController>(builder: (auth) {
//           return
...
//                         const CircleAvatar(
//                           radius: 5,
//                           backgroundColor: Color(0xff424899), // Bright green dot
//                         ),
...
//                                 "/",
//                                 style: mozillaTextRegularText(
//                                     color: DynamicColors.whiteClr, fontSize: 14),
//                               ),
//                             ),
//                           ),
//                           Text(
...
//                         borderRadius: BorderRadius.circular(10),
//                         border:
//                         Border.all(color: const Color(0xFFC4D9D4), width: 1),
//                       ),
//                       child: Row(
//                         children: [
//                           const Icon(
...
//
//   // ---------------------------------------------------------------------
//   // WEB / DESKTOP APP BAR (unchanged NestedMenuBar, shown when
//   // screenWidth >= kMobileBreakpoint)
//   // ---------------------------------------------------------------------
...
//
//   // ---------------------------------------------------------------------
//   // MOBILE / TABLET APP BAR (hamburger -> opens the drawer menu below,
//   // shown when screenWidth < kMobileBreakpoint)
//   // ---------------------------------------------------------------------
...
//             children: [
//               IconButton(
//                 icon: Icon(Icons.menu, color: DynamicColors.whiteClr),
...
//
//   // ---------------------------------------------------------------------
//   // MOBILE DRAWER MENU: renders the same `hoverMenu` tree used by the
//   // web NestedMenuBar as a collapsible list (ExpansionTile per submenu).
//   // ---------------------------------------------------------------------
...
//                 // Skip index 0 ("NEXUS" label item) - it has no onTap/children
//                 // and is already shown in the header above.
//                 children: _buildMobileMenuTiles(hoverMenu.skip(1).toList()),
//               ),
//             ),
//           ],
//         ),
...
//   }
//
//   List<Widget> _buildMobileMenuTiles(List<NestedMenuItem> items,
//       {double indent = 0}) {
...
//               item.title ?? "",
//               style: TextStyle(
//                   color: DynamicColors.textClr, fontWeight: FontWeight.w600),
//             ),
//             children:
//             _buildMobileMenuTiles(item.children!, indent: indent + 16),
//           ),
//         );
//       }
//       return ListTile(
...
//             style: TextStyle(color: DynamicColors.textClr)),
