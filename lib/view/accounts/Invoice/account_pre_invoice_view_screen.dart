...
class PreInvoiceViewWindowWrapper extends StatefulWidget {
  final AccountPreInvoiceController controller;
        ...
        child: AnimatedContainer(
          ...
          child: Column(
            children: [
              ...
              // Main Content
              Expanded(child: AccountPreInvoiceViewScreen(controller: widget.controller)),
            ],
          ),
        ),
      ),
...
class AccountPreInvoiceViewScreen extends StatelessWidget {
  final AccountPreInvoiceController controller;
  
  const AccountPreInvoiceViewScreen({Key? key, required this.controller}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Center(
              child: Text("ACCOUNT PRE INVOICE",
                  style: TextStyle(
                      fontSize: 28,
