...
//
//     final customerInvoiceFilterModel = customerInvoiceFilterModelFromJson(jsonString);

import 'dart:convert';

CustomerInvoiceFilterModel customerInvoiceFilterModelFromJson(String str) => CustomerInvoiceFilterModel.fromJson(json.decode(str));

String customerInvoiceFilterModelToJson(CustomerInvoiceFilterModel data) => json.encode(data.toJson());

class CustomerInvoiceFilterModel {
  bool? status;
  int? totalRecords;
  ...
  factory CustomerInvoiceFilterModel.fromJson(Map<String, dynamic> json) => CustomerInvoiceFilterModel(
    status: json["status"],
