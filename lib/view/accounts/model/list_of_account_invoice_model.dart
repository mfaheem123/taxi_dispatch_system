...
ListOfAccountInvoiceModel listOfAccountInvoiceModelFromJson(String str) =>
    ListOfAccountInvoiceModel.fromJson(json.decode(str));

String listOfAccountInvoiceModelToJson(ListOfAccountInvoiceModel data) =>
...
class ListOfAccountInvoiceModel {
  ...
  factory ListOfAccountInvoiceModel.fromJson(Map<String, dynamic> json) =>
      ListOfAccountInvoiceModel(
        status: json["status"],
        count: json["count"],
        page: json["page"],
        ...
        limit: json["limit"],
        accountInvoices: json["account_invoices"] == null
            ? []
            : List<AccountInvoice>.from(json["account_invoices"]!
                .map((x) => AccountInvoice.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "limit": limit,
        "account_invoices": accountInvoices == null
            ? []
            : List<dynamic>.from(accountInvoices!.map((x) => x.toJson())),
      };
}
...
class AccountInvoice {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "invoice_due_date":
            "${invoiceDueDate!.year.toString().padLeft(4, '0')}-${invoiceDueDate!.month.toString().padLeft(2, '0')}-${invoiceDueDate!.day.toString().padLeft(2, '0')}",
        "from_date":
...
class Account {
  ...
  factory Account.fromJson(Map<String, dynamic> json) => Account(
        ...
        subsidiary: json["subsidiary"] == null
            ? null
            : Department.fromJson(json["subsidiary"]),
      );
