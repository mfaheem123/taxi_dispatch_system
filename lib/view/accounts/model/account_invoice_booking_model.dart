...
class Total {
  String? fareTotal;
  String? parkingChargesTotal;
  String? waitingChargesTotal;
  String? extraDropChargesTotal;
  String? meetAndGreetTotal;
  String? congestionChargesTotal;
  String? total;
  String? grandTotal;

  Total({
    this.fareTotal,
    this.parkingChargesTotal,
    this.waitingChargesTotal,
    this.extraDropChargesTotal,
    this.meetAndGreetTotal,
    this.congestionChargesTotal,
    this.total,
    this.grandTotal,
  });
  ...
  factory Total.fromJson(Map<String, dynamic> json) => Total(
    ...
    parkingChargesTotal: json["parking_charges_total"],
    waitingChargesTotal: json["waiting_charges_total"],
    extraDropChargesTotal: json["extra_drop_charges_total"],
    meetAndGreetTotal: json["meet_and_greet_total"],
    congestionChargesTotal: json["congestion_charges_total"],
    total: json["total"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "parking_charges_total": parkingChargesTotal,
    "waiting_charges_total": waitingChargesTotal,
    "extra_drop_charges_total": extraDropChargesTotal,
    "meet_and_greet_total": meetAndGreetTotal,
    "congestion_charges_total": congestionChargesTotal,
    "total": total,
