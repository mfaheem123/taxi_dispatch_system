...
class CustomIpadWidget extends StatefulWidget {
  CustomIpadWidget({
    super.key,
    this.onTap,
  });
  ...
  @override
  State<CustomIpadWidget> createState() => _CustomIpadWidgetState();
}

class _CustomIpadWidgetState extends State<CustomIpadWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<DashboardController>(initState: (v) {
      ...
      return controller.dashboardDataLoader.value
        ...
        final bool isMobile = maxWidth <= 1024;
