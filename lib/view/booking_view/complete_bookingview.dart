                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Text(
                              "${AppText.completeBooking} (${controller.completedBookingModelData?.total.toString() ?? '0'})",
                              ...
                              child: CustomButton(
                                ...
                                widget: Padding(
                                  ...
                                  child: Icon(Icons.refresh,
                                      color: DynamicColors.whiteClr, size: 25),
                                ),
                              ),
                            ),
                          ],
                        ...
                        Container(
                          ...
                          child: PaginationWidget(
                            currentPage:
                                controller.completedBookingCurrentPage.value,
                            totalPages:
                                controller.completedBookingTotalPages.value,
...
//                             // DataCell(Center(child: Text((item.notes.toString() ?? 'N/A').toUpperCase()))),
