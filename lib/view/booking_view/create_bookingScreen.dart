                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(
                          flex: 1,
                          child: Text('DROP', style: TextStyle(fontWeight: FontWeight.bold)),
                        ),
                        Expanded(
                          flex: 2,
                          child: Container(
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          flex: 1,
                          child: Text('Q', style: TextStyle(fontWeight: FontWeight.bold)),
                        ),
                        Expanded(
                          flex: 1,
                          child: Container(
                    ...
                    Row(
                      children: [
                        Text('DRV', style: TextStyle(fontWeight: FontWeight.bold)),
                        SizedBox(width: 8),
                        Expanded(
                          child: Container(
                            height: 32,
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButton<String>(
                                ...
                                items: [
                                  DropdownMenuItem(child: Text('Driver 1'), value: '1'),
                                  DropdownMenuItem(child: Text('Driver 2'), value: '2'),
                                ],
                                onChanged: (value) {
                                  setState(() {
