...
class _PlotFareState extends State<PlotFare> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<FareController>(initState: (v) {
      ...
      return controller.getPlotVehicleTypeLoader.value
          ? Center(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                CustomDropdownField<VehicleTypee>(
                                  ...
                                  height: 35,
                                  items: controller
                                      .plotVehicleTypeModel!.vehicleTypes!,
                                    ...
                                    onPressed: () {
                                      if (controller.Zoneevalue != null) {
                                        ...
                                        String currentText = controller
                                            .ploteFareDescriptionController
                                            .text;
                                        controller
                                                .ploteFareDescriptionController
                                                .text =
                                    ...
                                    onPressed: () {
                                      if (controller.Zonee1value != null) {
                                        ...
                                        String newValue = controller
                                            ...
                                            .toUpperCase();
                                        String currentText = controller
                                            .ploteFareDescription2ndController
                                            .text;
