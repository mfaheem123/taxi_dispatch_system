...
//                                             child: Text(AppText.upload_image,
...
//                                     style:
//                                         mozillaTextSemiBoldText(fontSize: 14),
//                                     textAlign: TextAlign.center,
//                                   ),
//                                 ),
//                         ),
...
//                                 color: driver?.driverStatus == "login"
//                                     ? Colors.green
...
//                         children: [
//                           _infoTile(AppText.vehicle,
//                               driver?.vehicle?.vehicleNumber ?? "-"),
//                           _infoTile(
//                               AppText.startDate, driver?.startDate ?? "-"),
//                           _infoTile(
//                               AppText.vehicleType,
//                               driver?.vehicle?.vehicleType?.name.toString() ??
//                                   "SALOON"),
//                         ],
//                       ),
//                       SizedBox(height: 10),
...
//                           _infoTile(
//                               AppText.model, driver?.vehicle?.model ?? "-"),
//                           _infoTile(
//                               AppText.color, driver?.vehicle?.color ?? "-"),
//                         ],
//                       ),
//                       const SizedBox(height: 15),
//
...
//                           children: [
//                             _infoTile(AppText.phcdriver,
//                                 driver?.phcDriverExpiry ?? "00-00-0000"),
//                             _infoTile(AppText.phcvehicle,
//                                 driver?.phcVehicleExpiry ?? "00-00-0000"),
//                             _infoTile(AppText.insurance,
//                                 driver?.insuranceExpiry ?? "00-00-0000"),
//                             _infoTile(AppText.mot2,
//                                 driver?.mot2Expiry ?? "00-00-0000"),
//                             _infoTile(
//                                 AppText.mot, driver?.motExpiry ?? "00-00-0000"),
//                           ],
//                         ),
//                       ),
//
...
//                           children: [
//                             _infoTile(AppText.phcdriver,
//                                 driver?.phcDriverNumber ?? "N/A"),
//                             _infoTile(AppText.phcvehicle,
//                                 driver?.phcVehicleNumber ?? "N/A"),
//                             _infoTile(AppText.insurance,
//                                 driver?.insuranceNumber ?? "N/A"),
//                             _infoTile(
//                                 AppText.mot2, driver?.mot2Number ?? "N/A"),
...
//               final specificDriverData = controller
//                   .earningInfoListModel?.data?.drivers
//                   ?.firstWhereOrNull((d) => d.driverId == selectedId);
//
//               return Container(
...
//                   children: [
//                     _footerInfo(Icons.money, AppText.totalamount,
//                         "£ ${specificDriverData?.totalEarnings ?? '0.00'}"),
//                     _footerInfo(Icons.directions_car, AppText.totalBookings,
//                         "${specificDriverData?.totalBookings ?? '0'}"),
//                     _footerInfo(Icons.calendar_today, AppText.period,
