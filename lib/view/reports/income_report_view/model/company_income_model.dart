...
//
//     final companyIncomeModel = companyIncomeModelFromJson(jsonString);

import 'dart:convert';

import 'package:intl/intl.dart';

CompanyIncomeModel companyIncomeModelFromJson(String str) => CompanyIncomeModel.fromJson(json.decode(str));

String companyIncomeModelToJson(CompanyIncomeModel data) => json.encode(data.toJson());

class CompanyIncomeModel {
  bool? success;
  int? page;
  int? limit;
  int? total;
  ...
  factory CompanyIncomeModel.fromJson(Map<String, dynamic> json) => CompanyIncomeModel(
...
class CompanyDatum {
  ...
  String? eta;
  bool? fob;
  CompanyBookingStatus? bookingStatus;
  ...
  factory CompanyDatum.fromJson(Map<String, dynamic> json) => CompanyDatum(
    ...
    eta: json["eta"],
    fob: json["fob"],
    bookingStatus: json["booking_status"] == null ? null : CompanyBookingStatus.fromJson(json["booking_status"]),
    ...
    employee: json["employee"] == null ? null : CompanyEmployee.fromJson(json["employee"]),
...
class Dropoff {
  ...
  factory Dropoff.fromJson(Map<String, dynamic> json) => Dropoff(
    id: json["id"],
    name: json["name"],
    locationType: json["location_type"] == null ? null : DropoffLocationType.fromJson(json["location_type"]),
  );
...
class Pickup {
  ...
  factory Pickup.fromJson(Map<String, dynamic> json) => Pickup(
    id: json["id"],
    name: json["name"],
    locationType: json["location_type"] == null ? null : PickupLocationType.fromJson(json["location_type"]),
  );
...
class CompanyBookingStatus {
  ...
  factory CompanyBookingStatus.fromJson(Map<String, dynamic> json) => CompanyBookingStatus(
