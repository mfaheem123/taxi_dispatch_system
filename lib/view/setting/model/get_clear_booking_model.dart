...
//
//     final clearBookingModel = clearBookingModelFromJson(jsonString);

import 'dart:convert';

ClearBookingModel clearBookingModelFromJson(String str) => ClearBookingModel.fromJson(json.decode(str));
