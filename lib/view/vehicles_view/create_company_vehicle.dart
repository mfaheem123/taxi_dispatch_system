        ...
        final double fieldWidth = isMobile
            ...
            return
              ...
              SingleChildScrollView(
                  ...
                  Padding(padding: EdgeInsetsGeometry.symmetric(horizontal: 12.0),
                      child: Center(
                        child: Wrap(
                          runSpacing: 16,
                          spacing: 10,
                          ...
                          children: [
                            ...
                            labeledField(
                              ...
                              width: fieldWidth / 1.5,
                              child: SizedBox(height: 30, child: CustomTimePicker(
                                controller: controller.mot2ExpiryExpireTimeController,
                                onTimeSelected: (time) {
                                  setState(() {
                            ...
                            labeledField(
                              ...
                              width: fieldWidth / 1.5,
                              child: SizedBox(height: 30, child: CustomTimePicker(
                                controller: controller.insuranceExpiryTimeController,
                                onTimeSelected: (time) {
                                  setState(() {
                        ...
                        children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(color: Colors.white,
                                      ...
                                      image: controller.phcVehicleDocPic != null
                                          ? DecorationImage(
                                        image: MemoryImage(controller.phcVehicleDocPic!),
                                        fit: BoxFit.fill,
                                      )
                                          : (controller.singleVehicleData?.phcVehicleDocument != null
                                          ? DecorationImage(
                                        // Edit mode ki purani image
                                        // Note: Agar API sirf path bhej rah ho to Base URL add karein
                          ...
                          Column(
                            ...
                            children: [
                              Padding(
                                padding: const EdgeInsets.only(left: 7),
                                child: Text(AppText.mot2Doc, style: mozillaTextRegularText(fontSize: 11),
                                ),
                              ),
                              Stack(
                                alignment: Alignment.topRight,
