...
//
//     final getCustomerBookingModel = getCustomerBookingModelFromJson(jsonString);

import 'dart:convert';

GetCustomerBookingModel getCustomerBookingModelFromJson(String str) => GetCustomerBookingModel.fromJson(json.decode(str));

String getCustomerBookingModelToJson(GetCustomerBookingModel data) => json.encode(data.toJson());

class GetCustomerBookingModel {
  bool? success;
  int? count;
  ...
  factory GetCustomerBookingModel.fromJson(Map<String, dynamic> json) => GetCustomerBookingModel(
...
class Booking {
  ...
  factory Booking.fromJson(Map<String, dynamic> json) => Booking(
    ...
    customer: json["customer"] == null ? null : GetCustomer.fromJson(json["customer"]),
