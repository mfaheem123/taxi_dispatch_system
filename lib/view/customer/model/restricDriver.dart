...
//
//     final restricDriverModel = restricDriverModelFromJson(jsonString);

import 'dart:convert';

RestricDriverModel restricDriverModelFromJson(String str) => RestricDriverModel.fromJson(json.decode(str));
