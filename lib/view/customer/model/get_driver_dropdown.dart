...
//
//     final getDriverDropdown = getDriverDropdownFromJson(jsonString);

import 'dart:convert';

GetDriverDropdown getDriverDropdownFromJson(String str) => GetDriverDropdown.fromJson(json.decode(str));

String getDriverDropdownToJson(GetDriverDropdown data) => json.encode(data.toJson());

class GetDriverDropdown {
  bool? status;
  int? page;
  int? limit;
  int? total;
  ...
  factory GetDriverDropdown.fromJson(Map<String, dynamic> json) => GetDriverDropdown(
    status: json["status"],
    page: json["page"],
    limit: json["limit"],
    total: json["total"],
