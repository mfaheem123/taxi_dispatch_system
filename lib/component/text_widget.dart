...
class AppText {
  ...
  static get serviceApiKey => "SERVICE API KEY / TOKEN";
  static get mapApiKey => "MAP API KEY / TOKEN";
  ...
  static get webBookerConfiguration => "WEB BOOKER CONFIRMATION";
  static get customerAppConfirmation => "CUSTOMER APP CONFIRMATION";
  ...
  static get callFeatures => "CALL FEATURES";
