                      ...
                      child: CustomButton(
                        ...
                        onTap: (){
                          if(controller.controllerNoteController.text.isNotEmpty){
                            controller.controllerAlert.add(controller.controllerNoteController.text);
                          ...
                          children: [
                            Expanded(
                              child: Container(
                                ...
                                child: Text(controller.controllerAlert[index]),
                              ),
                            ),
                            Row(
                              children: [
                                Padding(
                                  ...
                                  child: CustomButton(
                                    onTap: (){
                                      controller.controllerNoteController.text = controller.controllerAlert[index];
                                      controller.update();
                                    },
                                    width: 30,
                                    height: 25,
