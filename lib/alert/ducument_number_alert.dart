                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _buildDropdownField(
                          label: "Subsidiary",
                          value: logic.selectedSubsidiary,
                          items: ["Subsidiary 1", "Subsidiary 2"],
                          onChanged: (val) {
                            logic.selectedSubsidiary = val;
                            logic.update();
                          },
                        ),
                      ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _buildCounterField(
                          ...
                          onUp: () => logic.changeCounterValue(logic.startNumberController, true),
                          onDown: () => logic.changeCounterValue(logic.startNumberController, false),
                        ),
                      ),
                      const SizedBox(width: 15),
                      Expanded(
                        child: _buildCounterField(
                          ...
                          onUp: () => logic.changeCounterValue(logic.incrementController, true),
                          onDown: () => logic.changeCounterValue(logic.incrementController, false),
                        ),
                      ),
                    ],
                  ),
      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            contentPadding: const EdgeInsets.only(left: 10, right: 4, top: 8, bottom: 8),
            suffixIcon: Column(
