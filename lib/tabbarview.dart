              ...
              child: Row(
                children: [
                  ...
                  buildMenuTab(Icons.person, "DRIVERS", "DRIVERS",
                      ["CREATE DRIVER", "LIST OF DRIVERS", "LIST OF INACTIVE DRIVERS", "LIST OF LOGGED IN DRIVERS", "LIST OF LOGGED OUT DRIVERS", "DRIVER ATTRIBUTES", "CREATE DRIVER COMMISSION", "LIST OF DRIVER COMMISSION"], driverKey),
                  buildMenuTab(Icons.account_circle, "ACCOUNTS", "ACCOUNTS",
                      ["CREATE ACCOUNT", "LIST OF ACCOUNTS", "CREATE CUSTOMER INVOICE", "CREATE CUSTOMER PRE INVOICE", "LIST OF CUSTOMER PRE INVOICES", "LIST OF CUSTOMER INVOICES", "CREATE ACCOUNT INVOICE", "LIST OF ACCOUNT INVOICES"], accountKey),
                  ...
                  buildMenuTab(Icons.settings, "SETTINGS", "SETTINGS",
                      ["COMPANY INFORMATION", "COMPANY CONFIGURATION", "PAYMENT TYPES COLOR CODE", "DOCUMENT NUMBER", "TEMPLATE SETTINGS", "BOOKING CLEARING UTILITY", "LOCATION TYPE SHORTCUTS", "VOIP SETTINGS", "SMS TRACKING", "EMAIL TRACKING", "CALL RECORDINGS", "RELEASE NOTES", "HELP", "WALLBOARD"], settingrKey),
                  SizedBox(
...
class _TopNavBarssState extends State<TopNavBarss> {
  final List<MenuItemData> menus = [
    ...
    MenuItemData("DRIVERS", Icons.person, ["CREATE DRIVER", "LIST OF DRIVERS", "LIST OF INACTIVE DRIVERS", "LIST OF LOGGED IN DRIVERS", "LIST OF LOGGED OUT DRIVERS", "DRIVER ATTRIBUTES", "CREATE DRIVER COMMISSION", "LIST OF DRIVER COMMISSION"]),
    ...
    MenuItemData("SETTINGS", Icons.settings, ["COMPANY INFORMATION", "COMPANY CONFIGURATION","PAYMENT TYPES COLOR CODE", "DOCUMENT NUMBER", "TEMPLATE SETTINGS", "BOOKING CLEARING UTILITY", "LOCATION TYPE SHORTCUTS", "VOIP SETTINGS", "SMS TRACKING","EMAIL TRACKING", "CALL RECORDINGS", "RELEASE NOTES", "HELP", "WALLBOARD"]),
  ];
