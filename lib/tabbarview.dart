              ...
              child: Row(
                children: [
                  ...
                  buildMenuTab(Icons.settings, "SETTINGS", "SETTINGS",
                      ["COMPANY INFORMATION", "COMPANY CONFIGURATION", "PAYMENT TYPES COLOR CODE", "DOCUMENT NUMBER", "TEMPLATE SETTINGS", "BOOKING CLEARING UTILITY", "LOCATION TYPE SHORTCUTS", "VOIP SETTINGS", "GENERAL SMS CONFIG", "SMS SETTINGS", "CHAT WITH DRIVER AND PASSENGER", "PERMISSION SETTINGS"], settingrKey),
                  SizedBox(
...
class _TopNavBarssState extends State<TopNavBarss> {
  final List<MenuItemData> menus = [
    ...
    MenuItemData("SETTINGS", Icons.settings, ["COMPANY INFORMATION", "COMPANY CONFIGURATION","PAYMENT TYPES COLOR CODE", "DOCUMENT NUMBER", "TEMPLATE SETTINGS", "BOOKING CLEARING UTILITY", "LOCATION TYPE SHORTCUTS", "VOIP SETTINGS", "GENERAL SMS CONFIG", "SMS SETTINGS", "CHAT WITH DRIVER AND PASSENGER", "PERMISSION SETTINGS"]),
  ];
